...
//3、	ID23 “选择文件夹上传”图片替换网站LOGO、手机站LOGO和地址栏图标
	...
	public void localImg() throws InterruptedException {
		...
		//替换网站LOGO
		webtest.type(inputElements.get(0), "c:\\demo\\OIP.jpg");
		Thread.sleep(2000);
		webtest.click("xpath=//button[@class='btn btn-primary']");	
		//替换手机站LOGO
		webtest.type(inputElements.get(1), "c:\\demo\\OIP.jpg");
		Thread.sleep(2000);
		//替换地址栏图标
		webtest.type(inputElements.get(2), "c:\\demo\\bitbug_favicon.ico");
		Thread.sleep(2000);
