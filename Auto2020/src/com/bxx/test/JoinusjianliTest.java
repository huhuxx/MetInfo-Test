...
public class JoinusjianliTest extends BaseTest {
	...
	public void test2() throws InterruptedException {
		...
		webtest.type("xpath=//*[@id='parameter-list-job-43-0-0']/tbody/tr[2]/td[3]/input", "这是必填项");
		webtest.type("xpath=//*[@id='parameter-list-job-43-0-0']/tbody/tr[3]/td[3]/input", "这是必填项");
		webtest.type("xpath=//*[@id='parameter-list-job-43-0-0']/tbody/tr[4]/td[3]/input", "这是必填项");
	...
	public void test3() throws InterruptedException {
		...
		Thread.sleep(5000);
		webtest.type("xpath=//*[@id='parameter-list-job-43-0-0']/tbody/tr[13]/td[2]/div/input","这是新添加的项");
	...
	public void test4() throws InterruptedException {
		...
		webtest.click(list.get(17));
		webtest.click(list.get(18));
