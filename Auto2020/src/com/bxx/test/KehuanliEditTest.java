...
//		添加新的内容带有本地视频的内容
		...
		webtest.type("xpath=//input[@class='webuploader-element-invisible']", "C:\\ABCD\\leave.mp4");
...
//		添加新的内容带有超链接的内容
	...
	public void testEditAdd10() throws InterruptedException {
		...
		webtest.type("name=file","C:\\ABCD\\2.jpg");
		webtest.type("name=file","C:\\ABCD\\3.jpg");
		webtest.type("name=file","C:\\ABCD\\4.jpg");
		webtest.click("xpath=//*[@class='uploadBtn state-ready']");
		webtest.leaveFrame();
